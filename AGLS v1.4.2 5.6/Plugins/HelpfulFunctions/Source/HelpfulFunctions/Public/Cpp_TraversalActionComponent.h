...
struct FTraversalTraceSettings
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
	bool RequireWalkableFloor = false;

	UPROPERTY(EditAnywhere, BlueprintReadWrite)
	float VerticalCapRoomFindScale = 0.76;
};
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FOnTraversalActionChanged, bool, ActionStarted, float, ActionDuration);
...
public:	
	...
	FOnTraversalActionChanged OnTraversalActionChanged;

	UFUNCTION(BlueprintCallable, Category = "Traversal Core", meta = (DisplayName = "Call On Traversal Deleage", Keywords = "Traversal"))
	void CallOnTraversalDeleage(bool bActionStarted = true, float Duration = 1.0);
...
protected:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta = (AllowPrivateAccess = "True", Category = "Debug Settings"))
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta = (AllowPrivateAccess = "True", Category = "Debug Settings"))
	float NotValidCapsuleCheckTime = 1.5;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta = (AllowPrivateAccess = "True", Category = "Traversal Settings"))
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta = (AllowPrivateAccess = "True", Category = "Traversal Settings"))  // <- New States Chooser Method. Then we need to set this in variable. Now states chooser parameters is store in data asset
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta = (AllowPrivateAccess = "True", Category = "Traversal Settings"))
	FVector2D CapsuleHaveRoomCheckScale = FVector2D(1.0, 1.0);

	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta = (AllowPrivateAccess = "True", Category = "Traversal Settings"))
	bool UseCapsuleDimensionsFromRef = false;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta = (AllowPrivateAccess = "True", Category = "Traversal Settings", EditCondition = "UseCapsuleDimensionsFromRef"))
	FVector2D DefaultCapsuleSize = FVector2D(30.0, 90.0);
